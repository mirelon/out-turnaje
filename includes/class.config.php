<?PHP
    ...
    class Config
    {
        ...
        private $productionServers = array('/^www\.outsiterz\.org$/');
        ...
        private function production()
        {
            ...
            define('WEB_ROOT', '/turnaje/');

            $this->dbReadHost      = 'localhost';
            $this->dbWriteHost     = 'localhost';
            $this->dbName          = 'out-turnaje';
            $this->dbReadUsername  = 'out-turnaje';
            $this->dbWriteUsername = 'out-turnaje';
            $this->dbReadPassword  = '*****';
