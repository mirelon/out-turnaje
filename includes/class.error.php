    ...
    class Error
    {
        ...
        public function blank($val, $id, $name = null)
        {
            if(trim($val) == '')
            {
                ...
                $this->add($id, "Políčko $name nemôžeš nechať prázdne.");
                return false;
            }
        ...
        public function passwords($pass1, $pass2, $id)
        {
            if($pass1 !== $pass2)
            {
                $this->add($id, 'Nové heslá sa nezhodujú.');
                return false;
            }
        ...
        public function date($val, $id)
        {
            ...
            {
                $this->add($id, 'Musíš zadať korektný dátum.');
                return false;
            }
        ...
        // Is a one date not greater than other
        public function compare_date($val1, $val2, $id)
        {
            if(dater($val1) > dater($val2))
            {
                $this->add($id, 'Dátum od nesmie prekročiť dátum do.');
                return false;
            }
